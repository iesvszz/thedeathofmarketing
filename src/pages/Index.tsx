...
import { Skull, Pill } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        {/* Hero Section */}
        <section className="min-h-screen flex flex-col items-center justify-center px-4 relative z-10 pt-24 pb-12">
          <div className={`text-center max-w-5xl mx-auto transition-all duration-1500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            ...
            {/* Doctor */}
            {/* CHANGE: Added mb-8 for consistent bottom margin */}
            <div className="mb-8">
              ...
              {/* CHANGE: Increased bottom margin to mb-8 */}
              <div className="relative w-80 h-80 md:w-88 md:h-88 mx-auto flex items-center justify-center mb-8">
              ...
              {/* CHANGE: Reduced bottom margin to mb-1 */}
              <h3 className="text-5xl font-bold text-white font-sans leading-tight mb-1">
                Jareer Samad
              </h3>
